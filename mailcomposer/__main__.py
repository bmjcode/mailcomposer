...
If at least one recipient is specified, mailcomposer will behave
like the Unix mail(1) utility:
...
If no recipient is specified, mailcomposer will open a new message
immediately without prompting for a subject or body, but will still
